...
import static Sanctuary.Sanctuary.makeEventPath;

public class IdentityCrisisEvent extends AbstractImageEvent {


    public static final String ID = Sanctuary.makeID("IdentityCrisisEvent");
            ...
            case 0:
                switch (i) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        imageEventText.loadImage("SanctuaryResources/images/events/IdentityCrisisEvent2.png");
